...
let UsersController = class UsersController {
    ...
    async create(createUserDto, req) {
        if (req.user.role !== client_1.Role.HOSPITAL_ADMIN && req.user.role !== client_1.Role.SUPER_ADMIN) {
    ...
    async update(id, dto, req) {
        if (req.user.role !== client_1.Role.HOSPITAL_ADMIN && req.user.role !== client_1.Role.SUPER_ADMIN && req.user.id !== id) {
